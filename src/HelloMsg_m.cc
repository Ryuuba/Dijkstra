...
int HelloMsg::getId() const
{
    return this->id;
}

void HelloMsg::setId(int id)
{
    this->id = id;
}

int HelloMsg::getCid() const
{
    return this->cid;
}

void HelloMsg::setCid(int cid)
{
    this->cid = cid;
}

int HelloMsg::getLevel() const
{
    return this->level;
}

void HelloMsg::setLevel(int level)
{
    this->level = level;
}
